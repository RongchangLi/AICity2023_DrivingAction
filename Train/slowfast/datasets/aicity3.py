...
class Aicity3(torch.utils.data.Dataset):
    """
    ...
    def __init__(self, cfg, mode, num_retries=10):
        ...
        assert mode in [
            ...
            "val",
            "test",
        ], "Split '{}' not supported for Aicity3".format(mode)
        self.mode = mode
        self.cfg = cfg
        ...
        logger.info("Constructing Aicity3 {}...".format(mode))
    ...
    def _construct_loader(self):
        ...
        path_to_file = os.path.join(
            ...
            "{}/{}/{}_{}.csv".format(self.cfg.split, self.cfg.manner, self.mode, self.cfg.view)
        )
        ...
        ), "Failed to load Aicity3 split {} from {}".format(
            self._split_idx, path_to_file
        )
        logger.info(
            "Constructing aicity3 dataloader (size: {}) from {}".format(
